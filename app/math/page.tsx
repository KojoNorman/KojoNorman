...
const questions = [
  ...
  {
    id: 2,
    question: "If you have a pizza cut into 8 slices and eat 2, what fraction is left?",
...
export default function MathQuiz() {
  ...
  return (
    ...
    <div className="min-h-screen bg-blue-50 flex flex-col items-center justify-center p-4">
      ...
      <Link href="/dashboard" className="absolute top-6 left-6 flex items-center gap-2 text-gray-500 hover:text-blue-600 transition">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 min-h-[400px] flex flex-col justify-center">
          ...
          {showResult ? (
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2">Math Genius!</h2>
              <p className="text-gray-500 mb-8">You scored {score} out of {questions.length}</p>
              
              <Link href="/">
                <button className="bg-blue-600 text-white px-8 py-3 rounded-full font-bold hover:bg-blue-700 transition w-full">
                  Back to Dashboard
                </button>
              </Link>
            </div>
